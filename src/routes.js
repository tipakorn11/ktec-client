...
const routes = [
  ...
  { key: 'จัดการแผนก', name: "จัดการแผนก", path: "/course", component: React.lazy(() => import("./views/course"))},
  { key: 'จัดการข้อมูล', name: "จัดการข้อมูล", path: "/manage-users", component: React.lazy(() => import("./views/manage-users"))},

...
const Users = ({ SESSION }) => {
  const { permission_view ,permission_edit ,permission_add,permission_approve,permission_cancel } = SESSION.PERMISSION
  return (
    <Switch>
      ...
      {permission_approve == 1 || permission_cancel == 1 ? <Route path = {`/file-approve/detail/:code`} render = {props => <Detail {...props}{...SESSION}/>}/>: null}
